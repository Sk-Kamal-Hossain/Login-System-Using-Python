...
class Login:
    def __init__(self, root):
        ...
        self.root.geometry("1080x600+100+50")
        self.root.resizable(False, False)

        #Background Image
        self.bg=ImageTk.PhotoImage(file="images/1.jpeg")
        ...
        subtitle = Label(Frame_login, text="Member Login Area", font=("Goudy old style", 15, "bold"), fg='#6162FF', bg="white").place(x=90, y=100)
        ...
        self.username.place(x=98, y=170, width=328, height=35)
        ...
        self.password.place(x=98, y=240, width=328, height=35)
        ...
        submit = Button(Frame_login, command=self.check_function, cursor="hand2", text="Log In", bd=0, font=("Goudy old style", 15), bg='#6162FF', fg="white").place(x=90, y=320, width=180, height=40)

    def check_function(self):
        if self.username.get()=="" or self.password.get()=="":
            messagebox.showerror("Error", "All fields are required", parent=self.root)

        elif self.username.get()!="skkamal" or self.password.get()!="12345":
